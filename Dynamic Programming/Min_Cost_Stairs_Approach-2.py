...
if __name__ == "__main__":
    ...
    n = len(cost)
    dp = [-1] * (n + 1)  # Memoization table to store computed results, initialized with -1
    
    min_cost = solve(cost, n - 1, dp)  # Calculate the minimum cost of climbing stairs starting from step n
